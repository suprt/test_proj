...
const (
	FileService_Upload_FullMethodName    = "/filesvc.v1.FileService/Upload"
	FileService_Download_FullMethodName  = "/filesvc.v1.FileService/Download"
	FileService_ListFiles_FullMethodName = "/filesvc.v1.FileService/ListFiles"
)
...
func (x *fileServiceUploadClient) Send(m *UploadChunk) error {
...
func (x *fileServiceDownloadClient) Recv() (*DownloadChunk, error) {
	m := new(DownloadChunk)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *fileServiceUploadServer) Recv() (*UploadChunk, error) {
	m := new(UploadChunk)
...
func (x *fileServiceDownloadServer) Send(m *DownloadChunk) error {
	return x.ServerStream.SendMsg(m)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "filesvc.v1.FileService",
	...
	Metadata: "filesvc/v1/filesvc.proto",
}
